...
const ProductDetails = () => {
  const { products, currency, addToCart, navigate } = useStoreContext();
  const { id } = useParams();
        ...
        <div className="text-sm w-full md:w-1/2">
          ...
          <div className="flex items-center mt-10 gap-4 text-base">
            ...
            <button
              ...
              className="w-full py-3.5 cursor-pointer font-medium bg-green-300 text-white hover:bg-green-600 transition" >
              Buy now
            </button>
          </div>
        </div>
      ...
      <div>
        <div className="flex flex-col items-center mt-20">
          <div className="flex flex-col items-center w-max">
            <p className="text-2xl text-gray-600 font-bold">Related Products</p>
            <div className="w-20 h-0.5 bg-green-400 rounded-full mt-2">
